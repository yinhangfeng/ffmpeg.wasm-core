...
FLAGS=(
  ...
  -s EXPORTED_FUNCTIONS="[_main, _emscripten_proxy_main, _export_pipe]"  # export main and proxy_main funcs
  -s EXPORTED_RUNTIME_METHODS="[FS, PIPEFS, cwrap, ccall, setValue, writeAsciiToMemory]"   # export preamble funcs
